...
<p><strong>step 3.</strong> 打开 MyProject/index.php ，输入以下代码然后保存：</p>
<pre class='code'>
<code class='php'>
&lt;?php
...
如果你使用ubuntu（或其他发行版本的linux），可以打开终端窗口，进入!MyProject目录，然后执行下面的命令。如果使用windwos作为开发环境，可以简单跳到下一个步骤。
</p>
<pre class='code'>
<code class='php'>
php5 index.php
...
<p><strong>setp 5.</strong> JeCat PHP Framework
